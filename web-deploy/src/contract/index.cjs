...
class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      recordAuthorship: (...args_1) => {
        if (args_1.length !== 5) {
          throw new __compactRuntime.CompactError(`recordAuthorship: expected 5 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const author_0 = args_1[1];
        const time_0 = args_1[2];
        const hash_0 = args_1[3];
        const msg_0 = args_1[4];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('recordAuthorship',
                                      'argument 1 (as invoked from Typescript)',
                                      'proof-of-authorship.compact line 14 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(author_0).concat(_descriptor_1.toValue(time_0).concat(_descriptor_0.toValue(hash_0).concat(_descriptor_1.toValue(msg_0)))),
        ...
        const result_0 = this._recordAuthorship_0(context,
                                                  partialProofData,
                                                  author_0,
                                                  time_0,
                                                  hash_0,
    ...
    this.impureCircuits = { recordAuthorship: this.circuits.recordAuthorship };
  }
  initialState(...args_0) {
    if (args_0.length !== 1) {
    ...
    state_0.setOperation('recordAuthorship', new __compactRuntime.ContractOperation());
    const context = {
  ...
  _recordAuthorship_0(context, partialProofData, author_0, time_0, hash_0, msg_0)
  {
    Contract._query(context,
                    partialProofData,
                    [
                     { push: { storage: false,
                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_5.toValue(0n),
                                                                            alignment: _descriptor_5.alignment() }).encode() } },
                     { push: { storage: true,
                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(author_0),
                                                                            alignment: _descriptor_1.alignment() }).encode() } },
                     { ins: { cached: false, n: 1 } }]);
    Contract._query(context,
                    partialProofData,
                    ...
                    [
                     { push: { storage: false,
                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_5.toValue(3n),
                                                                            alignment: _descriptor_5.alignment() }).encode() } },
                     { push: { storage: true,
                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(msg_0),
                                                                            alignment: _descriptor_1.alignment() }).encode() } },
                     { ins: { cached: false, n: 1 } }]);
    return [];
  }
